...
namespace PixelSquare
{
    ...
    {
        [SerializeField] private string m_LanguageId = "eng";
        ...
        public static event Action<string> NewTextDetected;
        ...
        {
            m_Ocr.SetImage(m_Image.texture);
            m_InputField.text = m_Ocr.GetText();
            NewTextDetected?.Invoke(m_InputField.text);
        }
